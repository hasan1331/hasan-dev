...
<body id="page-top" class="politics_version">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
			<img class="img-fluid" src="assets/images/main-logo.png" alt="" />
		</a>
	...
	<section id="home" class="main-banner parallaxie" style="background: url('assets/uploads/main-banner.png')">
		<div class="heading">
			<h1>hello i'm Hasan</h1>
			<p>"Experienced Software Engineer specializing in Laravel, PHP, SQL Server, MySQL, and PostgreSQL. <br>Dedicated to creating reliable software solutions, optimizing business processes, and delivering high-quality applications."</p>
			<h3 class="cd-headline clip is-full-width">
				<span>I am a </span>
                <span class="cd-words-wrapper">
                    <b class="is-visible">Software Engineer</b>
                    <b>Senior ERP Programmer</b>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right-box-pro wow fadeIn">
                        <img src="assets/uploads/main-profile.png" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- end container -->
			...
			<div class="gallery-list row">
				<div class="col-md-4 col-sm-6 gallery-grid gal_a gal_b">
					<div class="gallery-single fix">
						<img src="assets/uploads/gallery_img-01.jpg" class="img-fluid" alt="Image">
				...
				<div class="col-md-4 col-sm-6 gallery-grid gal_c gal_b">
					<div class="gallery-single fix">
						<img src="assets/uploads/gallery_img-02.jpg" class="img-fluid" alt="Image">
						<div class="img-overlay">
				...
				<div class="col-md-4 col-sm-6 gallery-grid gal_a gal_c">
					<div class="gallery-single fix">
						<img src="assets/uploads/gallery_img-03.jpg" class="img-fluid" alt="Image">
						<div class="img-overlay">
				...
				<div class="col-md-4 col-sm-6 gallery-grid gal_b gal_a">
					<div class="gallery-single fix">
						<img src="assets/uploads/gallery_img-04.jpg" class="img-fluid" alt="Image">
						<div class="img-overlay">
				...
				<div class="col-md-4 col-sm-6 gallery-grid gal_a gal_c">
					<div class="gallery-single fix">
						<img src="assets/uploads/gallery_img-05.jpg" class="img-fluid" alt="Image">
						<div class="img-overlay">
				...
				<div class="col-md-4 col-sm-6 gallery-grid gal_c gal_a">
					<div class="gallery-single fix">
						<img src="assets/uploads/gallery_img-06.jpg" class="img-fluid" alt="Image">
						<div class="img-overlay">
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="assets/uploads/testi_01.png" alt="" class="img-fluid alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="assets/uploads/testi_02.png" alt="" class="img-fluid alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="assets/uploads/testi_03.png" alt="" class="img-fluid alignleft">
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">
                    ...
                    <p class="footer-company-name">All Rights Reserved. &copy; 2026 <a href="#">hasan-dev</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
